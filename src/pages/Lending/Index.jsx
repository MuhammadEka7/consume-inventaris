                        ...
                        <table className="min-w-full text-left text-sm font-light">
                            ...
                            <tbody>
                                {lendings.map((lending, id) => (
                                    <tr key={lendings.id} className="border-b dark:border-neutral-500">
                                        ...
                                        <td className="whitespace-nowrap px-6 py-4">
                                            <Link to={'/lendings/edit/' + lending.id} className="px-4 py-2 bg-orange-500 rounded-lg mr-2 font-bold text-white">Edit</Link>    
                                            <button type="button" onClick={() => deleteLendings(lending.id)} className="px-4 py-2 bg-red-500 rounded-lg mr-2 font-bold text-white">Hapus</button>    
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
...
//             if (result.isConfirmed) {
//                 const token = localStorage.getItem('access_token');
//                 axios.delete(`http://localhost:8000/lendings/delete/all`, {
//                     headers: {
//                         'Authorization': 'Bearer ' + token,
//                     }
//                 })
